...
sidebar_label: "Libraries & imports"
tocDepth: 4
toc: true
...
Dart'ın muhteşem LEGO setine Libraries & Imports'a hoş geldiniz!\
Bu harika yapı taşlarıyla kodunuzu modüler hale getirebilir,başkalarının kodlarını kendi projenize dahil edebilir ve kendi kod kütüphanenizi oluşturabilirsiniz.\
Bir mimar gibi tasarla, bir koleksiyoner gibi topla ve
...
:::note
Dart'ın public veya private gibi erişim belirleyici anahtar kelimeler yerine alt çizgi kullanmasının nedenini öğrenmek için [SDK issue 3338](https://github.com/dart-lang/sdk/issues/33383)'e bakabilirsiniz.
:::
