...
<span style={{ fontSize: '24px' }}>
 Kodunuza süper güçler kazandırmaya hazır mısınız?\
 İşte karşınızda Metadata!
 Bu küçük `@` işaretli süper kahramanlar, kodunuza ekstra bilgiler ekler,
 özel yetenekler kazandırır ve onu daha akıllı hale getirir.\
 Bir süper kahraman gibi kodunuzu güçlendirecek, bir etiketleyici gibi
 organize edecek ve bir büyücü gibi özel yetenekler katacaksınız.\
 Metadata büyüsü başlasın! ✨
</span>
</BorderBox>
